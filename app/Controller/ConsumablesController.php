  ...
  class ConsumablesController extends AppController {
    ...
    private function _initViewData() {
      $this->set([
        ...
        'itemTypes' => $this->ItemType->getFormatedData(['type_class' => 'consumable']),
        'showWeightField' => true,
        'statuses' => $this->Consumable->getStatuses(),
        'ratings' => $this->Consumable->getRatings()
      ]);
    }

    public function index() {
      // Set conditions in where clause if search query or show inactive flag are present
      $conditions = ['AND' => ['ItemType.type_class' => 'consumable']];
      ...
      $this->Paginator->settings = [
        ...
        'contain' => ['Consumable','ItemType','MeasurementUnit']
      ];

      $this->set([
        'consumables' => $this->paginate('Item'),
      ]);
    }
    ...
    public function save($id = null) {
      ...
      if ( $this->request->is(['post','put']) ) {
        ...
        $this->Item->setStatuses($this->Consumable->getStatuses());
