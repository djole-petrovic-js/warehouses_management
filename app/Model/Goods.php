  ...
  class Goods extends Model {
    ...
    public $validate = [
      'pid' => [
        ...
        'unique' => [
          'rule' => 'isUnique',
          'message' => 'Vec postoji roba sa ovim PID-om'
        ]
      ],
      'hts_number' => [
        'validateHSNumber' => [
    ...
    public function beforeValidate($options = []) {
      if ( $this->Item->data['Item']['status'] === 'for sale' && empty($this->data['Goods']['product_release_date']) ) {
        $this->data['Goods']['product_release_date'] = date('Y-m-d');
      }
