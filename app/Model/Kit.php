  ...
  class Kit extends Model {
    ...
    public $validate = [
      'pid' => [
        ...
        'unique' => [
          'rule' => 'isUnique',
          'message' => 'Vec postoji kit sa ovim PID-om'
        ]
      ],
      'hts_number' => [
        'validateHSNumber' => [
    ...
    public function beforeValidate($options = []) {
      if($this->Item->data['Item']['status'] === 'for sale' && empty($this->data['Kit']['product_release_date'])){
        $this->data['Kit']['product_release_date'] = date('Y-m-d');
      }
      return true;
    }
